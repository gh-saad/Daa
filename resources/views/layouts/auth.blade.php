...
<head>
    ...
    <title>@yield('page-title') | {{ !empty(admin_setting('title_text')) ? admin_setting('title_text') : config('app.name', 'DAA ERP') }}</title>
    ...
    <meta name="author" content="DAA ERP">
                    ...
                    <div class="container">
                        <div class="navbar-brand">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{ get_file(sidebar_logo()) }}{{'?'.time()}}" alt="{{ config('app.name', 'DAA ERP') }}" class="navbar-brand-img auth-navbar-brand">
                            </a>
                        </div>
