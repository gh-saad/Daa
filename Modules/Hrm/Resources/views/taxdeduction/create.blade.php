{{ Form::open(['url' => 'taxdeduction', 'method' => 'post']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('tax_deduction_value_type', $tax_deduction, null, ['class' => 'form-control amount_type ', 'required' => 'required', 'placeholder' => 'Select Type']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('tax_deduction_value', __('Tax Value'), ['class' => 'form-label']) }}
                {{ Form::number('tax_deduction_value', null, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => 'Enter Tax Value', 'min' => '0', 'step' => 'any']) }}
            </div>
        </div>
        <hr>
        <div class="col-md-6">
