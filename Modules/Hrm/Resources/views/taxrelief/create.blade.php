{{ Form::open(['url' => 'taxrelief', 'method' => 'post']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('tax_relief_value_type', $tax_relief, null, ['class' => 'form-control amount_type ', 'required' => 'required', 'placeholder' => 'Select Type']) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
