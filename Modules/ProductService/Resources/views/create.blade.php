...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('vehicle_status', __('Vehicle Status'), ['class' => 'form-label']) }}<span
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('purchased_by', __('Purchased By'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('purchased_status', __('Purchased Status'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('sale_price', __('Push price'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('bid_date', __('Bid Date'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('engine_no', __('Engine No'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('engine_cc', __('Engine CC'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('sale_type', __('Sale Type'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
