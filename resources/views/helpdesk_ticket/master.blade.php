...
<head>
    ...
    <title>@yield('page-title') |
        {{ !empty(company_setting('title_text', $ticket->created_by)) ? company_setting('title_text', $ticket->created_by ) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'DAA ERP') }}
    </title>
...
<body class="{{ !empty(company_setting('color',$ticket->created_by)) ? company_setting('color',$ticket->created_by) : 'theme-1' }}">
    @yield('content')
