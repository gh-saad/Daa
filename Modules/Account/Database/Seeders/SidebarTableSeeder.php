...
class SidebarTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $chart_account = Sidebar::where('title',__('Chart Of Accounts'))->where('parent_id',$banking->id)->where('type','company')->first();
        if($chart_account == null)
        {
            Sidebar::create( [
                ...
                'permissions' => 'chart of account manage',
                'module' => 'Account',
                'type'=>'company',
            ]);
        }
