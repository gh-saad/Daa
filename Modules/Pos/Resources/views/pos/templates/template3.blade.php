...
<head>
    ...
    <title>{{ \Modules\Pos\Entities\Pos::posNumberFormat($pos->pos_id)}} | {{ !empty(company_setting('title_text')) ? company_setting('title_text') : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'DAA ERP') }}</title>
    <link
