                                            ...
                                            <div class="d-flex radio-check">
                                                <div class="form-check form-check-inline form-group col-md-3">
                                                    <input type="radio" id="product" value="product"
                                                        name="invoice_type_radio" class="form-check-input code" {{ ($invoice->invoice_module =='account') ? 'checked="checked"' :''}}>
                                                ...
                                                <div class="form-check form-check-inline form-group col-lg-3 col-md-6">
                                                    <input type="radio" id="project1" value="project"
                                                        name="invoice_type_radio" class="form-check-input code" {{ ($invoice->invoice_module =='taskly') ? 'checked="checked"' :''}}>
                                                    <label class="custom-control-label"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::date('issue_date', \Carbon\Carbon::parse($invoice->issue_date)->format('Y-m-d'), ['class' => 'form-control ', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::date('due_date', \Carbon\Carbon::parse($invoice->due_date)->format('Y-m-d'), ['class' => 'form-control ', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchCustomerDetails(customerId) {
                const url = customerSelect.attr('data-url').replace(':id', customerId);
            ...
            // Fetch customer details on page load for the preselected customer
        ...
        $(document).ready(function() {
            ...
            function loadPreSelectedItems() {
                productsSelectedArray.forEach(function(item) {
                    ...
                    const convertedPrice = itemPrice;
                    const convertedDiscount = itemDiscount;
                    ...
                    $('#items').append(`
                        <tr data-item-id="${itemId}">
                            ...
                            <td>${itemTax}%</td>
                            <td class="net-amount">${totalAmount.toFixed(2)} {{ company_setting('defult_currancy') }}</td>
                        </tr>
                    `);
                    ...
                    $('#item-inputs').append(`
                        <div class="item-input-group" data-item-id="${itemId}">
                            ...
                            <input type="hidden" name="item_net_amounts[]" value="${totalAmount.toFixed(2)}">
                        </div>
                    `);
                });
