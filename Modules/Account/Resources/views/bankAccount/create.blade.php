...
<div class= modal-body>
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Form::select('chart_account_id', $chart_accounts,'', array('id' => 'chart_account_id', 'class' => 'form-control select2','required'=>'required')) }}
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::select('currency_id', $currencies,'', array('id' => 'currency_id', 'class' => 'form-control select2','required'=>'required')) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
