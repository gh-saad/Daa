...
class JournalEntryController extends Controller
{
    ...
    {
        if (Auth::user()->can('journalentry manage')) {
    ...
    {
        if (Auth::user()->can('journalentry create')) {
...
//                ->pluck('code_name', 'id');
            ...
            return view('doubleentry::journalEntry.create', compact('chartAccounts','journalId'));
        } else {
        ...
        if (Auth::user()->can('journalentry create')) {
            ...
            for ($i = 0; $i < count($accounts); $i++) {
                ...
                $data = [
                    ...
                    'user_id' => $journalItem->created_by,
    ...
    public function show(JournalEntry $journalEntry)
    {
        ...
        if (Auth::user()->can('journalentry show')) {
    ...
    public function edit(JournalEntry $journalEntry)
    {
        if (Auth::user()->can('journalentry edit')) {
            ...
            return view('doubleentry::journalEntry.edit', compact('chartAccounts', 'journalEntry','subAccounts'));
        } else {
            return response()->json(['error' => __('Permission denied.')], 401);
        }
    }
...
//        dd($journalEntry);
    ...
    public function destroy(JournalEntry $journalEntry)
    {
        ...
        if (Auth::user()->can('journalentry delete')) {
            if ($journalEntry->created_by == creatorId()) {
