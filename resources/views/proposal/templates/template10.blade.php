...
<head>
    ...
    <title>
        ...
        |
        {{ !empty(company_setting('title_text', $proposal->created_by, $proposal->workspace)) ? company_setting('title_text', $proposal->created_by, $proposal->workspace) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'DAA ERP') }}
    </title>
    <link
