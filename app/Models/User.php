    ...
    public static function CompanySetting($id = null,$workspace_id = null)
    {
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "title_text" => !empty(admin_setting('title_text')) ? admin_setting('title_text') : "DAA ERP",
                "footer_text" => !empty(admin_setting('footer_text')) ? admin_setting('footer_text') :"Copyright © DAA ERP",
                "site_rtl" => "off",
                "cust_darklayout" => "off",
                "site_transparent" => "on",
                "color" => "theme-1",
